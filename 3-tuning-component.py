...
def hyperparameter_tuning():
    ...
    aiplatform.init(project='ultra-path-428923-i6',
                    location='us-central1',
                    staging_bucket='gs://london_bikes_staging_bucket1')

    # Define the custom job from local script
    custom_job = aiplatform.CustomJob.from_local_script(
        ...
        args=[
            ...
            '--model-path', 'forecasting_model.pkl'
        ]
    )
    ...
    # Find the best trial
    best_trial = job.trials[0] # Initialise variable
    ...
    best_model_path = best_trial.output_dir + '/model.pkl'
